...
export const NavbarLocation = () => {
    return (
        <nav className="navbar navbar-expand-lg navbar-light navbar-location">
            <div className="dropdown">
                <button className="btn btn-outline-dark dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                    Location &nbsp;
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-geo-alt location" viewBox="0 0 16 16">
            ...
            <div>
                <form>
                    <input type="search" className="input" placeholder=" Type Here To Search"/>
                    <button className="btn btn-outline-dark search-btn">
